"""
main.py&ndash;ÃÂ FastAPI application + WhatsApp webhook handler (multi-tenant v5).

Entry point for the Clinic AI Agent.

Endpoints:
  GET  /                         &ndash;ÃÂ Health check
  GET  /webhook                  &ndash;ÃÂ Meta webhook verification (one-time setup)
  POST /webhook                  &ndash;ÃÂ Incoming WhatsApp messages
  GET  /health                   &ndash;ÃÂ Detailed health check (DB + config)
  GET  /admin?key=<SECRET>       &ndash;ÃÂ Super-admin web dashboard (Arun only)
  POST /admin/action?key=<SECRET>&ndash;ÃÂ Dashboard actions (suspend/activate/payment/new_client)
  GET  /clinic?key=<dashboard_key>ÃÂ¢ÃÂÃÂ Per-clinic read-only dashboard (doctors)

Routing on every incoming message:
  0. If sender is ADMIN_PHONE&ndash;ÃÂ super-admin command handler (admin.py)
  1. Extract phone_number_id from webhook (which clinic's number was messaged)
  2. Look up clients table&ndash;ÃÂ resolve client row
  3. Check client status (active / grace / suspended / expired)
  4. If doctor&ndash;ÃÂ doctor management flow
  5. If patient has active follow-up&ndash;ÃÂ followup flow
  6. Otherwise&ndash;ÃÂ AI booking agent flow
"""
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ Logging setup&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ Razorpay client (lazy-init, only when KEY_ID is configured)&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
def _razorpay_client():
    ...
    try:
        ...
        logger.warning("razorpay package not installed&ndash;ÃÂ payment links disabled")
        return None
...
async def _create_razorpay_link(invoice: dict, client_row: dict) -> str | None:
    ...
    description  = (
        f"Clinic AI Agent&ndash;ÃÂ {invoice.get('plan','').title()} Plan&ndash;ÃÂ "
    ...
    try:
        ...
        if link_id:
            ...
            logger.info("[Razorpay] Payment link created: %s&ndash;ÃÂ %s", link_id, link_url)
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ Webhook deduplication (in-memory, 5-minute TTL)&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
_seen_message_ids: dict[str, float] = {}   # message_id&ndash;ÃÂ first-seen timestamp
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ Per-user rate limiting (in-memory, sliding window)&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ WhatsApp webhook signature verification&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
# warning)&ndash;ÃÂ set it in production for security.
...
async def _verify_webhook_signature(request: Request, body: bytes) -> bool:
    ...
    if not app_secret:
        logger.warning(
            "ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ  WHATSAPP_APP_SECRET not set&ndash;ÃÂ webhook signature NOT verified. "
    ...
    if not signature_header:
        logger.warning("ÃÂ°ÃÂÃÂÃÂ« Webhook request missing X-Hub-Signature-256 header&ndash;ÃÂ rejected")
        return False
    ...
    if not hmac.compare_digest(signature_header, expected_sig):
        logger.warning(
            "ÃÂ°ÃÂÃÂÃÂ« Webhook signature mismatch (got=%s, expected=%s&mdash;Â¦)&ndash;ÃÂ rejected",
            signature_header[:20],
            expected_sig[:20],
        )
        return False
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ App lifecycle&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

@asynccontextmanager
async def lifespan(app: FastAPI):
    logger.info("ÃÂ°ÃÂÃÂÃÂ¥ Clinic AI Agent starting up&mdash;Â¦")
    try:
        settings.validate()
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ HTTPS redirect middleware&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
@app.middleware("http")
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ Health check&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
<title>Clinic AI Agent&ndash;ÃÂ WhatsApp Bot for Doctor Clinics</title>
...
<section class="hero" style="padding:72px 24px 56px">
  <div class="hero-inner">
    <div class="hero-text">
      ...
      <h1>Your Clinic on <span>WhatsApp</span>&ndash;ÃÂ 24/7 Automated</h1>
      <p class="hero-sub">Patients book appointments, get reminders, cancel and reschedule&ndash;ÃÂ all on WhatsApp. Zero calls. Zero manual work. Your clinic runs itself.</p>
      <div class="hero-ctas">
        <a href="/signup"><button class="btn-primary">ÃÂ°ÃÂÃÂÃÂ Start Free Trial</button></a>
        <a href="#pricing"><button class="btn-ghost">View Pricing&ndash;ÃÂ</button></a>
      </div>
    ...
    <div class="hero-phone">
      <div class="phone-frame"><div class="phone-screen">
        ...
        <div class="p-chat">
          ...
          <div class="p-msg r">Hi, I want to book an appointment<div class="p-time">10:02&ndash;ÃÂÃÂ¢ÃÂÃÂ</div></div>
          <div class="p-msg l">Welcome! ÃÂ°ÃÂÃÂÃÂ May I know your name?<div class="p-time">10:02</div></div>
          <div class="p-msg r">Rahul Gupta<div class="p-time">10:03&ndash;ÃÂÃÂ¢ÃÂÃÂ</div></div>
          ...
          <div class="p-msg r">10:30 AM<div class="p-time">10:03&ndash;ÃÂÃÂ¢ÃÂÃÂ</div></div>
...
<section class="features-bg" id="features">
  <div class="container">
    <div class="text-center reveal">
      ...
      <p class="section-sub">All features work over WhatsApp&ndash;ÃÂ no app, no website, no training required for patients.</p>
    </div>
    <div class="features-grid">
      <div class="feat-card reveal"><div class="feat-icon">ÃÂ°ÃÂÃÂÃÂ</div><div class="feat-title">Smart Appointment Booking</div><div class="feat-desc">Patients message your clinic WhatsApp and get available slots instantly. Bot confirms the appointment automatically&ndash;ÃÂ no human needed.</div><div class="feat-tags"><span class="ftag">24/7 Active</span><span class="ftag">Instant Confirm</span></div></div>
      ...
      <div class="feat-card reveal"><div class="feat-icon">ÃÂ°ÃÂÃÂÃÂ</div><div class="feat-title">Admin Web Dashboard</div><div class="feat-desc">See all appointments, patient history, and usage stats in a clean web dashboard. Manage everything from any browser&ndash;ÃÂ no install needed.</div><div class="feat-tags"><span class="ftag">All Plans</span><span class="ftag">Web-Based</span></div></div>
    </div>
  </div>
</section>
...
<section class="how-bg" id="how">
  <div class="container">
    ...
    <div class="steps">
      ...
      <div class="step reveal"><div class="step-num">2</div><div class="step-title">We Activate Your Bot</div><div class="step-desc">We set up your WhatsApp bot on Meta's official API&ndash;ÃÂ the same platform used by banks and airlines. Fully secure and verified.</div><div class="step-arrow">ÃÂ¢ÃÂÃÂ</div></div>
...
<section class="pricing-bg" id="pricing">
  <div class="container">
    ...
    <div class="setup-fee-note reveal" style="margin-top:28px"><strong>One-time setup fee:&ndash;ÃÂ¹1,500</strong>&ndash;ÃÂ We register your WhatsApp number, configure your bot, and run a live test. Done in 24 hours.</div>
    <div class="setup-fee-note reveal" style="margin-top:8px">ÃÂ¢ÃÂÃÂ 7-day free trial &nbsp;ÃÂÃÂ·&nbsp;&ndash;ÃÂ No credit card required &nbsp;ÃÂÃÂ·&nbsp;&ndash;ÃÂ Cancel any time &nbsp;ÃÂÃÂ·&nbsp;&ndash;ÃÂ All Indian +91 numbers supported</div>
  </div>
</section>
...
function toggleBilling(){{
  ...
  [1,2,3].forEach(i=>{{
    ...
    document.getElementById('annual'+i).textContent=isAnnual?'Billed&ndash;ÃÂ¹'+fmt(annual[i-1])+'/year (2 months FREE)':'';
  }});
}}
...
async def admin_dashboard(request: Request):
    """
    Web admin dashboard&ndash;ÃÂ shows all clients, subscriptions, payments, usage.
...
async def privacy_policy():
    html = """<!DOCTYPE html><html><head><title>Privacy Policy&ndash;ÃÂ Clinic AI Agent</title>
...
async def terms_of_service():
    html = """<!DOCTYPE html><html><head><title>Terms of Service&ndash;ÃÂ Clinic AI Agent</title>
    <meta charset="utf-8"><style>body{font-family:Arial,sans-serif;max-width:800px;margin:40px auto;padding:20px;line-height:1.6}h1{color:#25D366}h2{color:#333}</style></head>
...
async def admin_action(request: Request):
    """
    Dashboard action endpoint&ndash;ÃÂ called by JS fetch() in the admin HTML.
    ...
    logger.info("[Admin Action] %s&ndash;ÃÂ %s", action, {k: v for k, v in body.items() if k != "action"})
    ...
    try:
        if action == "suspend":
            ...
            if not key_id or not key_secret:
                return JSONResponse({"ok": False, "error": f"Keys missing: id={'set' if key_id else 'empty'} secret={'set' if key_secret else 'empty'}"}, status_code=500)
...
async def signup_page(request: Request, plan: str = "", ref: str = ""):
    ...
    ?plan=starter|pro|suite  &ndash;ÃÂ pre-selects a plan card
    ?ref=CODE                &ndash;ÃÂ pre-fills referral code
    """
...
<head>
  ...
  <title>Start Free Trial&ndash;ÃÂ Clinic AI Agent</title>
  <style>
...
<body>
  <div class="top-nav">
    <a href="/"><span class="nav-logo-icon">ÃÂ°ÃÂÃÂÃÂ¥</span>&ndash;ÃÂ Back to Home</a>
  </div>
  <div class="hero">
    <div class="trial-badge">ÃÂ°ÃÂÃÂÃÂ 7-Day Free Trial&ndash;ÃÂ No Credit Card Needed</div>
    <h1>Your Clinic's 24/7 WhatsApp Receptionist</h1>
    <p>Automate appointment booking, reminders, and patient communication&ndash;ÃÂ set up in under 10 minutes.</p>
  </div>
        ...
        <div class="form-grid">
          ...
          <div class="field full">
            ...
            <select id="plan" name="plan" required>
              <option value="starter" {'selected' if plan=='starter' else ''}>Starter&ndash;ÃÂ&ndash;ÃÂ¹999/month</option>
              <option value="pro" {'selected' if plan in ('pro','') else ''}>Pro&ndash;ÃÂ&ndash;ÃÂ¹1,999/month&ndash;­ÃÂ Most Popular</option>
              <option value="suite" {'selected' if plan=='suite' else ''}>Suite&ndash;ÃÂ&ndash;ÃÂ¹2,999/month</option>
            </select>
          </div>
        </div>
...
async def signup_submit(request: Request):
    ...
    try:
        ...
        if existing.data:
            # Already exists&ndash;ÃÂ show friendly message
    ...
    if settings.ADMIN_PHONE:
        admin_msg = (
            ...
            f"ÃÂ°ÃÂÃÂÃÂ¨&mdash;ÂÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ {doctor_name}\n"
...
def _signup_success_html(clinic_name: str, doctor_name: str, plan: str, referral_code: str = "") -> str:
    ...
    <div class="referral-box">
      ...
      <p style="font-size:13px;color:#444;margin-bottom:10px;">
        Share your unique referral link. Every doctor friend who subscribes earns you <strong>1 free month</strong>&ndash;ÃÂ no limit!
      </p>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>You're Signed Up!&ndash;ÃÂ Clinic AI Agent</title>
  <style>
  ...
  <div class="card">
    ...
    <div class="steps">
      ...
      <div class="step"><div class="num">1</div>
        <div>Our team sets up your dedicated WhatsApp Business number&ndash;ÃÂ usually within a few hours.</div>
      </div>
      ...
      <div class="step"><div class="num">4</div>
        <div>Your 7-day trial begins from activation day&ndash;ÃÂ full access, no credit card needed.</div>
      </div>
    </div>
...
async def invoice_view(token: str):
    ...
    # Pull client info&ndash;ÃÂ enriched by get_invoice_by_token with _clinic_name etc.
    ...
    period_label = f"{_fmt(invoice['period_start'])}&ndash;ÃÂ {_fmt(invoice['period_end'])}"
    ...
    if status == "PAID":
        ...
        <div style="background:#E8F5E9;border:2px solid #4CAF50;border-radius:8px;
          ...
          <span style="color:#2E7D32;font-size:18px;font-weight:bold;">ÃÂ¢ÃÂÃÂ PAID{('&ndash;ÃÂ ' + paid_at) if paid_at else ''}</span>
        </div>"""
    ...
    <div class="inv-body">
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              <strong>Clinic AI Agent&ndash;ÃÂ {plan_label} Plan</strong><br>
...
async def calendar_connect(dashboard_key: str):
    ...
    Doctor visits this URL from their clinic dashboard&ndash;ÃÂ redirected to Google consent.
...
async def calendar_callback(request: Request):
    """
    Step 2 of Google Calendar OAuth&ndash;ÃÂ Google redirects here after consent.
    ...
    try:
        ...
        if doctor_phone:
            await whatsapp.send_text(
                ...
                f"ÃÂ°ÃÂÃÂÃÂ Sync runs every 15 minutes&ndash;ÃÂ any event you mark as *Busy* in Google Calendar "
...
async def razorpay_webhook(request: Request):
    """
    Razorpay payment webhook&ndash;ÃÂ auto-marks invoices paid.

    Setup in Razorpay Dashboard&ndash;ÃÂ Webhooks:
    ...
    On payment_link.paid:
      ...
      5. Activate client subscription (trial&ndash;ÃÂ active)
      6. WhatsApp doctor "ÃÂ¢ÃÂÃÂ Payment received"
      7. Notify admin
    """
    raw_body = await request.body()

    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Signature verification&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    if settings.RAZORPAY_WEBHOOK_SECRET:
        ...
        if not hmac.compare_digest(expected, sig):
            logger.warning("[Razorpay] Webhook signature mismatch&ndash;ÃÂ rejecting")
            raise HTTPException(status_code=400, detail="Invalid signature")
    else:
        logger.warning("[Razorpay] RAZORPAY_WEBHOOK_SECRET not set&ndash;ÃÂ skipping signature check")
    ...
    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Extract identifiers&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    try:
    ...
    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Find invoice&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    if invoice["status"] == "paid":
        logger.info("[Razorpay] Invoice %s already paid&ndash;ÃÂ skipping", invoice["id"])
        return JSONResponse({"status": "already_paid"})

    client_id  = invoice["client_id"]
    amount_inr = amount_paid_paise / 100

    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Mark invoice paid&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    db.mark_invoice_paid(invoice["id"], client_id, razorpay_payment_id=rzp_pay_id)

    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Record payment in payments table&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    db.record_payment(
        client_id=client_id,
        amount=amount_inr,
        method="razorpay",
    ...
    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Activate client if still on trial&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    #&ndash;ÃÂÃÂ¢ÃÂÃÂ WhatsApp doctor: payment confirmed&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    if client_row:
        ...
        if doctor_phone:
            confirm_msg = (
                f"ÃÂ¢ÃÂÃÂ *Payment Received&ndash;ÃÂ Thank you, Dr. {doctor_name}!*\n\n"
                f"Invoice: *{inv_num}*\n"
                f"Plan: *{plan_label}*\n"
        ...
        if settings.ADMIN_PHONE:
            ...
            try:
                await whatsapp.send_text(
                    ...
                    f"ÃÂ°ÃÂÃÂÃÂµ&ndash;ÃÂ¹{amount_inr:,.0f} via Razorpay\n"
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ WhatsApp webhook verification (GET)&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def verify_webhook(request: Request):
    ...
    logger.info("ÃÂ°ÃÂÃÂÃÂ Webhook verify&ndash;ÃÂ mode=%s token=%s", mode, (token or "none")[:8] + "***")

    if mode == "subscribe" and challenge:
        if token == settings.WHATSAPP_VERIFY_TOKEN:
            logger.info("ÃÂ¢ÃÂÃÂ Webhook verified by Meta (token matched)")
        else:
            logger.warning("ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ  Token mismatch but accepting&ndash;ÃÂ Railway has '%s...', Meta sent '%s...'",
                           (settings.WHATSAPP_VERIFY_TOKEN or "")[:6],
                           (token or "")[:6])
        return PlainTextResponse(content=challenge, status_code=200)

    # Meta health ping with no params&ndash;ÃÂ return 200
    return PlainTextResponse(content="OK", status_code=200)


#&ndash;ÃÂÃÂ¢ÃÂÃÂ WhatsApp incoming messages (POST)&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def receive_message(request: Request):
    ...
    """
    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Read raw body first (needed for HMAC verification)&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    try:
        raw_body = await request.body()
    except Exception:
    ...
    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Verify Meta webhook signature&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    if not await _verify_webhook_signature(request, raw_body):
        return JSONResponse({"status": "forbidden"}, status_code=403)

    #&ndash;ÃÂÃÂ¢ÃÂÃÂ Parse JSON&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    try:
    ...
    try:
        ...
        #&ndash;ÃÂÃÂ¢ÃÂÃÂ Deduplication: drop re-delivered webhooks&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        if _is_duplicate_message(message_id):
            logger.info("ÃÂ¢ÃÂÃÂ¡ Duplicate message_id=%s from %s&ndash;ÃÂ ignored", message_id, phone)
            return JSONResponse({"status": "duplicate"})

        #&ndash;ÃÂÃÂ¢ÃÂÃÂ Rate limiting: protect against flooding&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        if _is_rate_limited(phone):
            logger.warning("ÃÂ°ÃÂÃÂÃÂ« Rate limit hit for %s&ndash;ÃÂ dropping message", phone)
            return JSONResponse({"status": "rate_limited"})

        #&ndash;ÃÂÃÂ¢ÃÂÃÂ STEP 0: Super-admin routing&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        if _is_admin(phone):
            logger.info("[Router]&ndash;ÃÂ Admin flow (from=%s)", phone)
        ...
        #&ndash;ÃÂÃÂ¢ÃÂÃÂ STEP 1: Resolve which clinic this message is for&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        client = _resolve_client(phone_number_id)
        if client is None:
            # Unknown phone number ID&ndash;ÃÂ not a registered clinic
            logger.warning(
                "Unrecognised phone_number_id '%s'&ndash;ÃÂ no client found, ignoring",
                phone_number_id,
            )
        ...
        client_id    = client["id"]
        client_pid   = client.get("whatsapp_phone_id") or settings.WHATSAPP_PHONE_ID
        client_token = client.get("whatsapp_token") or None  # None&ndash;ÃÂ falls back to global token

        logger.info(
            "ÃÂ°ÃÂÃÂÃÂ© Message from %s (%s)&ndash;ÃÂ client=%s (%s): %s",
            phone, name, client_id, client["name"], text[:80],
        )

        #&ndash;ÃÂÃÂ¢ÃÂÃÂ STEP 2: Check subscription status&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        if client["status"] in ("suspended", "expired"):
            logger.info(
                "[Router] Client %s is %s&ndash;ÃÂ blocking message", client_id, client["status"]
            )
        ...
        if client["status"] == "grace" and _is_doctor(phone, client):
            ...
            await whatsapp.send_text(
                phone,
                f"ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ *Subscription Expired&ndash;ÃÂ Grace Period*\n\n"
        ...
        #&ndash;ÃÂÃÂ¢ÃÂÃÂ STEP 3: Doctor flow (skip patient tracking + follow-up check)&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        if _is_doctor(phone, client):
            logger.info("[Router]&ndash;ÃÂ Doctor flow (client=%s)", client_id)
            if message_id:
        ...
        #&ndash;ÃÂÃÂ¢ÃÂÃÂ STEP 4: Save / update patient record&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        db.upsert_patient(client_id, phone, name)

        if message_id:
            await whatsapp.mark_as_read(message_id, phone_id=client_pid, token=client_token)

        #&ndash;ÃÂÃÂ¢ÃÂÃÂ STEP 5: Active follow-up?&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        if await is_followup_response(client_id, phone):
            logger.info("[Router]&ndash;ÃÂ Follow-up flow (client=%s)", client_id)
            await handle_followup_response(phone, name, text, client=client)
            return JSONResponse({"status": "ok", "flow": "followup"})

        #&ndash;ÃÂÃÂ¢ÃÂÃÂ STEP 6: AI booking agent&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        logger.info("[Router]&ndash;ÃÂ Booking flow (client=%s)", client_id)
        await handle_booking_flow(phone, name, text, client=client)
        ...
        #&ndash;ÃÂÃÂ¢ÃÂÃÂ Notify the patient / doctor that triggered the error&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        if phone:
            try:
                await whatsapp.send_text(
                    phone,
        ...
        #&ndash;ÃÂÃÂ¢ÃÂÃÂ Alert admin on WhatsApp&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        if settings.ADMIN_PHONE:
            try:
...
#&ndash;ÃÂÃÂ¢ÃÂÃÂ Helpers&ndash;ÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
def _resolve_client(phone_number_id: str) -> dict | None:
    ...
    one client in the DB&ndash;ÃÂ makes migration from single-tenant painless.
    """
    if phone_number_id:
